...
type Information struct {
	...
	InternalConnectorType       string `json:"internal_connector_type,omitempty"`
	ExternalReferenceDesignator string `json:"external_reference_designator,omitempty"`
	ExternalConnectorType       string `json:"external_connector_type,omitempty"`
...
func Parse(s *dmi.SubSmBiosStructure) (info *Information, err error) {
	...
	info = &Information{
		...
		InternalConnectorType:       ConnectorType(s.GetByte(0x01)).String(),
		ExternalReferenceDesignator: s.GetString(0x2),
		ExternalConnectorType:       ConnectorType(s.GetByte(0x03)).String(),
		Type:                        PortType(s.GetByte(0x04)).String(),
	}
	return info, nil
}
